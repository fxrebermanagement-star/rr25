(function(){
  ...
  var PX={segen:1,fluch:1,ueber:1,schaden:1};
  ...
  openR=function(id,wer){
    ...
    function draw(){
      ...
      var extra="";
      if(/Wesenheit/i.test(titel) && PX[id]){
        extra='<div class="row"><button type="button" class="btn ghost" id="wOhne">Ohne</button><button type="button" class="btn primary" id="wMit">Mit</button></div><p class="sub" id="wWahl">jetzt: '+(mem.mit?"mit Wesenheit":"ohne Wesenheit")+'</p>';
      }
      if(last && PX[id]){
