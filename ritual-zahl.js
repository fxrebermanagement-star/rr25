(function(){
  ...
  function paint(){
    ...
    var z=load();
    el.innerHTML=
      '<button type="button" class="zbtn'+(z.n3>=3?" on":"")+'" data-z="n3">3<span>'+z.n3+'/3</span></button>'+
      '<button type="button" class="zbtn'+(z.n6>=6?" on":"")+'" data-z="n6">6<span>'+z.n6+'/6</span></button>'+
      '<button type="button" class="zbtn'+(z.n9>=9?" on":"")+'" data-z="n9">9<span>'+z.n9+'/9</span></button>';
  }
  function tap(key){
  ...
  function screen(){
    if(document.getElementById("zahl")) return;
    var sec=document.createElement("section");
    sec.id="zahl"; sec.className="screen";
    sec.innerHTML='<div class="hero"><h2>369</h2><p class="sub">Heute. Tippen zählt.</p></div>'+
      '<div id="zahlBox"></div>'+
      '<div class="row"><button type="button" class="btn ghost" id="zahlBack">Zurück</button></div>';
  ...
  css.textContent=[
    ...
    "#zahl .zbtn.on{background:linear-gradient(165deg,#ff7ad9,#7ef0e6);color:#14081c;border-color:transparent}",
    "#zahl .zbtn.on span{color:#14081c}",
    "#zahl .hero h2{text-align:center;letter-spacing:.2em}"
  ].join("");
