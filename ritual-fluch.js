(function(){
  var STEPS=[
    ...
    ["Standort",
      "Tu:\nFüsse. Drei Atemzüge.\n\nSprich:\nIch bin hier.\nIch bin klar.\nIch trage.\nNoch nicht [Name]."],
    ["Mein Feld",
      "Tu:\nGrenze um DEINEN Körper. Bevor du gehst.\n\nSprich:\nIch schliesse mein Feld hart.\nErst danach [Name]."],
    ["Ruf",
    ...
    ["Siegel",
      "Tu:\nJetzt als du. Hand vor die Flamme.\n\nSprich:\nVersiegelt.\nÜbergeben.\nEs läuft."],
    ["Schluss",
      "Sprich:\nDanke Feld.\n\nTu:\nWasser. Alltag.\nFoto bleibt unten."]
  ];
  ...
  for(var i=0;i<R.length;i++){
    if(R[i].id==="fluch"){
      R[i].t="Fluch";
      R[i].s="Wort innen. Raus. Dann Siegel.";
      R[i].tag="Person X";
      R[i].need=["Name"];
      R[i].steps=STEPS;
      R[i]._ich=1;
  ...
  if(!found) R.push({id:"fluch",t:"Fluch",s:"Wort innen. Raus. Dann Siegel.",tag:"Person X",need:["Name"],steps:STEPS,_ich:1});
})();
