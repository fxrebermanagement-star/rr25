(function(){
  var KEYS=["rr25_ritual_v1","rr25_notiz_v1","rr25_wer","rr25_personen","rr25_369","rr25_dank","rr25","rr25_bak","rr25_pack_bak"];
  ...
  function bar(host){
    ...
    box.className="row bakBar"; box.style.margin=".2rem 0 .8rem";
